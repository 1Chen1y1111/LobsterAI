...
import { ScheduledTaskRunWithName } from '@/types/scheduledTask'
        ...
        return (
          <div
            ...
            className={`grid grid-cols-[1fr_1fr_80px] items-center gap-3 px-4 py-3 border-b dark:border-claude-darkBorder/50 border-claude-border/50 transition-colors ${
              run.sessionId ? 'hover:bg-claude-surfaceHover/50 dark:hover:bg-claude-darkSurfaceHover/50 cursor-pointer' : ''
            }`}
          ...
          >
            ...
            <div className="text-sm dark:text-claude-darkTextSecondary text-claude-textSecondary truncate">
              ...
              {run.durationMs !== null && <span className="ml-1.5 text-xs opacity-70">({formatDuration(run.durationMs)})</span>}
            </div>
