...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    confirmDeleteProject:
      "确定要删除这个项目吗？项目内聊天将移回到聊天列表。此操作不可撤销。",
    ...
    emailHint163:
      "请使用授权码，而非账户密码。需先在网页端设置中开启 IMAP/SMTP 服务",
    emailHintQQ:
      "请使用授权码，而非账户密码。需先在网页端设置中开启 IMAP/SMTP 服务",
    ...
    imConnectivityCheckTitle_feishu_event_subscription_required:
      "飞书事件订阅要求",
    imConnectivityCheckTitle_discord_group_requires_mention:
      "Discord 群聊触发规则",
    imConnectivityCheckTitle_telegram_privacy_mode_hint:
  ...
  en: {
    ...
    baseUrlHint1:
      "Usually just the domain, path will be appended automatically",
    baseUrlHintExample1: "https://api.siliconflow.cn",
    ...
    apiFormatHint:
      "Select protocol compatibility: Anthropic Compatible or OpenAI Compatible",
    zhipuCodingPlanHint:
      "When enabled, uses the GLM Coding Plan dedicated API endpoint",
    zhipuCodingPlanEndpointHint:
    ...
    moonshotCodingPlanHint:
      "When enabled, uses the Moonshot Coding Plan dedicated API endpoint",
    moonshotCodingPlanEndpointHint:
      "When using Coding Plan, the system will automatically switch to the dedicated Coding endpoint",
    import: "Import",
    export: "Export",
    ...
    // Initialization
    initializationError:
      "Failed to initialize application. Please check your configuration.",
    apiKeyNotConfigured:
    ...
    coworkWorkingDirectoryHint:
      "LobsterAI will execute commands in this directory",
    coworkSystemPrompt: "System Prompt",
    coworkSystemPromptPlaceholder: "Set custom instructions for LobsterAI...",
    coworkSystemPromptHint:
      "Optional system prompt to customize LobsterAI's behavior",
    coworkModelSettingsRequired:
      "Please configure models and API keys in Model Settings first.",
    ...
    coworkMemoryEnabledHint:
      "Inject stable user facts into the <userMemories> prompt block.",
    coworkMemorySimpleHint:
    ...
    coworkMemoryRecallIntervalHint:
      "Inject memory every N turns, recommended: 3",
    coworkMemoryCrudTitle: "Managed memory entries",
    coworkMemoryManageHint:
      "View, search, add, edit, and delete memory entries here.",
    ...
    coworkMemoryEmbeddingAutoDownloadHint:
      "When disabled, you must provide a local model path",
    ...
    coworkSandboxUnsupported:
      "Built-in VM sandbox is not supported on this system",
    ...
    coworkSandboxSelectionBlocked:
      "Sandbox unavailable. Please choose Auto or Local.",
    ...
    coworkPermissionDescription:
      "LobsterAI is requesting to perform the following action",
    ...
    skillsDescription:
      "Pre-packaged best practices and tools for your AI agent",
    ...
    emailHintGmail:
      "If 2FA is enabled, use an App Password instead of your account password",
    emailHint163:
    ...
    imConnectivityNoResult:
      "No diagnostics yet. Test after enabling the gateway.",
    ...
    imConnectivityCheckTitle_feishu_group_requires_mention:
      "Feishu Group Trigger Rule",
    imConnectivityCheckTitle_feishu_event_subscription_required:
      "Feishu Event Subscription Requirement",
    imConnectivityCheckTitle_discord_group_requires_mention:
      "Discord Group Trigger Rule",
    imConnectivityCheckTitle_telegram_privacy_mode_hint:
      "Telegram Privacy Mode",
    imConnectivityCheckTitle_dingtalk_bot_membership_hint:
      "DingTalk Conversation Permission",
    imConnectivityCheckTitle_nim_p2p_only_hint: "NetEase IM P2P Mode",
    imConnectivityCheckSuggestion_missing_credentials:
      "Fill required credentials and test again.",
    imConnectivityCheckSuggestion_auth_check:
    ...
    nimAccountHint:
      "IM account ID (accid) created in NetEase IM console account management",
    ...
    nimGuideStep4:
      "Generate a Token for this account (long-term validity recommended)",
    nimAppKeyHint: "Obtain from app information in NetEase IM console",
    nimTokenHint:
      "Access credential generated for this account (long-term validity recommended)",
    ...
    scheduledTasksEmptyHint:
      "Create scheduled tasks to automate AI execution on a schedule",
    ...
    scheduledTasksFormValidationWorkingDirectoryRequired:
      "Task working directory is required",
    ...
    scheduledTasksFormValidationDatetimeFuture:
      "Execution time must be in the future",
    scheduledTasksFormValidationIntervalPositive:
    ...
    scheduledTasksAutoDisabledErrors:
      "Task auto-disabled due to too many consecutive errors",
    ...
    scheduledTasksFormExpiresAtHint:
      "Optional. Task will stop running after this date",
    ...
    scheduledTasksFormNotifyHint:
      "Optional. Send task results via IM after completion",
    ...
    scheduledTasksToggleWarningExpired:
      "This task has expired. It will not run after enabling",
  },
};
    ...
    try {
      ...
      if (languageInitialized !== true) {
        ...
        if (hasCustomLanguage) {
          ...
          console.log(
            `[i18n] Legacy user detected with custom language: ${config.language}`,
          );
          ...
          try {
            const systemLocale =
              await window.electron.appInfo.getSystemLocale();
  ...
  t(key: string): string {
    ...
    if (!translation) {
      ...
      const fallbackTranslation =
        translations[this.currentLanguage === "zh" ? "en" : "zh"][key];
