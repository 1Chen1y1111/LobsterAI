...
export const { setActions, selectAction, selectPrompt, setLoading, clearSelection } = quickActionSlice.actions

export const quickActionReducer = quickActionSlice.reducer
