import { ScheduledTask, ScheduledTaskRun, ScheduledTaskRunWithName, ScheduledTaskViewMode, TaskState } from '@/types/scheduledTask'
...
export const scheduledTaskReducer = scheduledTaskSlice.reducer
